...
#                    time_derivatives.append(h_next.x - h_curr.x)
                    time_derivatives.append(h_next.x) # Predicted (n+1)-th value by GNN
...
#                     time_derivatives.append(h_next.x + (5*random.random()-10)*h_curr.x)
                ...
                # SSPRK3
                h_mid1 = 0.5 * h_curr.x - 0.5 * coeff*laplacian.mm(h_curr.x)
                h_mid2 = 0.5 * h_mid1 - 0.5 * coeff*laplacian.mm(h_mid1)
                h_mid3 = 2/3 * h_curr.x + 1/6 * h_mid2 - 1/6 * coeff*laplacian.mm(h_mid2)
                h_new = 0.5 * h_mid3 - 0.5 * coeff*laplacian.mm(h_mid3)
                spatial_derivatives.append(h_new) # (n+1)-th value by Physics law 
